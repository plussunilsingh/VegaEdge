        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start perspektive-container">
          ...
          <div className="relative preserve-3d animate-float">
            ...
            <div
              ...
              style={
                {
                  borderTopColor: plan.color || "#10b981",
                  borderRightColor: plan.color || "#10b981",
                } as any
              }
            >
              {/* Surface Gloss */}
              ...
              <div className="relative z-10">
                <h1 className="text-white text-5xl font-black mb-4 tracking-tighter">
                  {plan.name}
                </h1>
                <div className="flex items-baseline gap-2 mb-10 transform translate-z-40">
                  <span className="text-primary text-6xl font-black tracking-tight">
                    {plan.price}
                  </span>
                ...
                <div className="space-y-6 mb-12">
                  ...
                  {plan.features?.map((feature: string, idx: number) => (
                    <div
                      key={idx}
                      className="flex items-start gap-4 bg-white/5 p-5 rounded-2xl transform hover:translate-x-2 transition-transform border border-white/5"
                    >
                ...
                <div className="bg-primary/10 border border-primary/30 p-8 rounded-3xl relative overflow-hidden group">
                  ...
                  <p className="text-gray-300 font-medium leading-relaxed relative z-10">
                    After successful payment, screenshot your receipt and send to{" "}
                    <span className="text-white font-black text-lg">+91 {COMPANY_PHONE}</span>. Your
                    institutional-grade dashboard will be live in{" "}
                    <span className="text-primary italic font-black">30 mins</span>.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="bg-white p-10 rounded-[40px] shadow-[0_20px_100px_rgba(255,255,255,0.08)] mb-8 max-w-md w-full border border-gray-100 transform hover:scale-[1.01] transition-all duration-500">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-500 font-black uppercase tracking-widest text-xs mt-2 opacity-60">
                  Verified Institutional Merchant
                </p>
              </div>
              ...
              <div className="mt-10 pt-8 border-t border-gray-100 text-center">
                <p className="font-black text-2xl text-black mb-8 tracking-tight">
                  Account: Dinesh Tarkar
                </p>
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4 items-center px-4 mt-8">
                  <div className="flex flex-col items-center gap-2">
                    <div className="h-8 flex items-center">
                      <img
                        src="/payment_mode/gpay-logo.svg"
                        alt="GPAY"
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <div className="h-8 flex items-center">
                      <img
                        src="/payment_mode/paytm-logo.svg"
                        alt="Paytm"
                        className="h-5 w-auto object-contain"
                      />
                    </div>
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <div className="h-8 flex items-center">
                      <img
                        src="/payment_mode/bharatpe-logo.png"
                        alt="BharatPe"
                        className="h-5 w-auto object-contain"
                      />
                    </div>
            ...
            <p className="text-gray-500 text-sm font-bold tracking-widest uppercase opacity-40">
              Strictly No Refunds After Activation
            </p>
          </div>
        </div>
      </main>
