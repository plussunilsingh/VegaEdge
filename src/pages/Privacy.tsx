          ...
          <div className="max-w-4xl mx-auto bg-card rounded-2xl p-8 md:p-12 shadow-lg">
            ...
            <div className="prose prose-lg max-w-none space-y-6 text-muted-foreground">
              <section>
                ...
                <p>
                  At {COMPANY_NAME}, we collect information that you provide directly to us,
                  including your name, email address, phone number, and any other information you
                  choose to provide. We also automatically collect certain information about your
                  device when you use our platform, including IP address, browser type, and usage
                  data.
                </p>
              </section>
