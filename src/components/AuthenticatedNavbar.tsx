        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          {sessionTimeLeft > 0 && (
            <div className="flex items-center gap-2 text-sm">
              ...
              <span
                className={`font-medium ${sessionTimeLeft <= 30 ? "text-red-600" : "text-muted-foreground"}`}
              >
          ...
          <div className="md:hidden bg-black border-t border-gray-800">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <button
                ...
                className="block w-full text-left px-3 py-2 rounded-md text-base font-medium text-white hover:text-primary hover:bg-gray-900"
              >
                Logout
              </button>
              <Link
                to="/contact"
                onClick={toggleMenu}
                className="block px-3 py-3 rounded-md text-base font-medium text-white hover:text-primary hover:bg-gray-900 border-t border-gray-800/10"
              >
                Contact Us
              </Link>
            </div>
