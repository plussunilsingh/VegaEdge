  ...
  return (
    <section id="pricing" className="py-24 bg-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
          ...
          {plans.map((plan) => (
            <div 
              ...
              className={`relative group cursor-pointer transition-all duration-500 hover:-translate-y-4 rounded-3xl p-8 border ${
                plan.recommended 
                  ? 'bg-gray-900 border-primary shadow-[0_0_40px_rgba(225,29,72,0.15)]' 
        ...
        <div className="mt-20 text-center p-8 rounded-3xl bg-gray-900/50 border border-gray-800 animate-pulse-slow">
           <h4 className="text-white text-xl font-bold mb-2">Lifetime Access Special</h4>
           <p className="text-gray-400">Want unlimited access forever? Contact our support for the exclusive Enterprise License.</p>
        </div>
      </div>
    </section>
  );
